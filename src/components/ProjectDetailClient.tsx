  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 py-12 sm:py-20">
        ...
        {/* ── Shared Layout Hero — this layoutId matches the card in Projects.tsx ── */}
        <motion.div
          layoutId={`project-card-${project.id}`}
          className="glass-card rounded-[24px] overflow-hidden mb-12 border border-outline-variant"
          ...
          <div className="aspect-video relative">
            ...
            >
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <span className="px-3 py-1 rounded-full bg-primary/90 text-on-primary text-[10px] font-label-caps uppercase tracking-widest backdrop-blur">
                  {project.category}
                </span>
                <span className="flex items-center gap-1.5 text-white/70 text-xs backdrop-blur">
                  <Clock size={12} />
                  {project.timeline}
                </span>
              </div>
              <h1 className="font-h1 text-2xl sm:text-4xl text-white font-bold drop-shadow-lg">
                {project.title}
              </h1>
            </motion.div>
          </div>
        ...
        <motion.p
          ...
          className="text-lg text-muted font-body-lg max-w-3xl leading-relaxed mb-10"
        >
        ...
        <motion.div
          ...
          className="glass-card p-8 sm:p-10 rounded-[24px] mb-16"
        >
        ...
        <motion.div
          ...
          className="glass-card p-8 sm:p-10 rounded-[24px] text-center"
        >
